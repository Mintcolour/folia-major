...
export default {
  ...
  "mods": {
    ...
    "errors": {
      ...
      "install-entry-missing": "Paket tidak memiliki berkas entri yang dideklarasikan di mod.json",
      "install-visualizer-missing": "Paket tidak memiliki berkas visualizer yang dideklarasikan di mod.json",
