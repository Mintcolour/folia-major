...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "visualizer-toggle-glow-blur-quantize": { "title": "Perbaiki animasi lirik macet di Linux", "description": "Perbaiki animasi lirik yang terkadang macet setelah pemutaran lama di Linux" },
  ...
  "mods": {
    ...
    "signatureUnsignedDetail": "Tanpa tanda tangan resmi: ini mod pihak ketiga yang belum ditinjau Folium. Aktifkan hanya mod dari sumber yang Anda percayai.",
    "signatureInvalid": "Tanda tangan tidak cocok",
    "signatureInvalidDetail": "Mod ini ditandatangani, tetapi tanda tangannya gagal diperiksa ({{reason}}), jadi bukan lagi mod terverifikasi resmi. Biasanya berkasnya diubah setelah ditandatangani; jika bukan Anda yang mengubahnya, jangan aktifkan.",
    "signatureReasons": {
      "malformed": "berkas tanda tangan rusak",
      "unknown-key": "kunci penanda tangan tidak dipercaya",
      "revoked-key": "kunci penanda tangan telah dicabut",
      "mod-mismatch": "ditandatangani untuk id atau versi mod lain",
      "bad-signature": "tanda tangan tidak valid",
      "unverifiable": "berkas tidak dapat diperiksa",
      "digest-mismatch": "berkas diubah setelah ditandatangani",
      "revoked-mod": "versi mod ini ditarik oleh Folium"
    },
    "reload": "Muat ulang",
  ...
  "options": {
    ...
    "glowBlurQuantizeDesc": "Memperbaiki animasi lirik yang terkadang macet setelah pemutaran lama di Linux. Chromium membocorkan memori bersama saat radius blur glow lirik berubah setiap frame; opsi ini menggambar glow dengan cara yang tidak bocor dan tampilannya hampir sama. Aktif secara default di Linux, nonaktif di platform lain.",
