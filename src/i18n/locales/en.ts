...
export default {
  ...
  "mods": {
    ...
    "errors": {
      ...
      "install-entry-missing": "The package is missing the entry file declared in mod.json",
      "install-visualizer-missing": "The package is missing a visualizer file declared in mod.json",
