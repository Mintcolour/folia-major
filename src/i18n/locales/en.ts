...
export default {
  "notifications": {
    ...
    "transparentBgWallpaperUnsupported": "Transparent background is not supported in wallpaper mode",
    ...
    "cursorAutoHideOn": "The cursor will hide together with the player controls",
    "cursorAutoHideOff": "The cursor will stay visible when the player controls hide",
  ...
  "status": {
    ...
    "neteaseApiStartupFailedDetail": "NetEase API failed to start, so some online features are unavailable: {{reason}}",
    ...
    "transcodeFallbackStarting": "Converting unsupported audio for playback...",
    "transcodeFallbackReady": "Audio converted; resuming playback",
    "transcodeFallbackFailed": "Audio conversion failed",
  ...
  "commandPalette": {
    ...
    "lyricExportPlaceholder": "Choose what to export below",
    ...
    "commands": {
      ...
      "lyric-staff-absorb-cycle": { "title": "Opening credits absorb mode", "description": "Cycle whether neighbouring lines are folded into the credit block" },
      ...
      "visualizer-toggle-glow-blur-quantize": { "title": "Fix lyric animation freeze on Linux", "description": "Fix lyric animations occasionally freezing after long playback on Linux" },
      ...
      "lattice-focus-current": { "title": "Lattice focus current song", "description": "Center the playing song in the queue collage" },
      "navigate-lattice": { "title": "Lattice open", "description": "Show the play queue as a queue collage" },
      ...
      "home-card-position-toggle": { "title": "Remember home card position", "description": "Toggle restoring each home section to its last card" },
      ...
      "settings-toggle-native-mac-fullscreen-button": { "title": "Native macOS fullscreen button", "description": "Toggle whether the macOS window control enters native fullscreen instead of maximizing" },
      "settings-toggle-cursor-auto-hide": { "title": "Hide cursor with player controls", "description": "Toggle whether the mouse pointer disappears together with the auto-hidden player controls" },
  ...
  "ui": {
    ...
    "panelHint": "Click the title to open the side panel",
    "play": "Play",
    "pause": "Pause",
    "close": "Close",
    "volume": "Volume",
  ...
  "lyricExport": {
    ...
    "noLyrics": "No lyrics to export",
    "failed": "Lyric export failed",
    "settingsEntry": "Batch export lyrics",
    "surfaceDesc": "Packs the lyrics already on this device into one zip. Each song is exported as playback shows it, so lyrics you imported or matched by hand win. Instrumentals and songs without lyrics are skipped and listed in manifest.json.",
    "scopeOnline": "Online song cache",
    ...
    "resolveOnlineDesc": "Asks the music service for titles this device does not know, for file names. When off, those songs are named by ID",
    "start": "Export",
    "cancel": "Cancel",
    "phaseCollectStart": "Collecting lyrics…",
    "phaseCollect": "Collecting lyrics {{done}}/{{total}}",
    "phaseMetadata": "Looking up titles {{done}}/{{total}}",
    "phasePackage": "Packing…",
    "done": "Exported {{exported}}, skipped {{skipped}}",
    "empty": "No lyrics found to export",
    "cancelled": "Lyric export cancelled",
    "closeCancels": "Closing the palette while exporting cancels the export",
    "sectionScope": "What to include",
    "sectionFormats": "Formats",
    "sectionNames": "File names",
    "lrcExtras": "Also in LRC",
    "extraTranslation": "Translation",
    "extraRomanization": "Romanization",
    "nothingSelected": "Pick at least one source and one format"
  },
  "lyricFile": {
    "button": "Import / export lyrics",
    "title": "Lyric file",
    "description": "Import a lyric file to replace the version on screen, or save this song’s lyrics as a file.",
  ...
  "lyricSegmentation": {
    "statusDefault": "Default segmentation",
    "sourceAi": "AI",
    "sourceManual": "Manual",
    "appliedCount": "{{count}} lines",
    "runAi": "Segment with AI",
    "copyPrompt": "Copy prompt",
    "copyCurrent": "Copy current",
    "reset": "Restore default",
    "importPlaceholder": "Paste the result here: one line per lyric line, words separated by \"/\", or the JSON array",
    "noLyrics": "No lyrics to segment",
    "saved": "Word segmentation saved",
    "restored": "Default word segmentation restored",
    "promptCopied": "Prompt and lyrics copied",
    "currentCopied": "Current segmentation copied",
    "partialFailure": "{{count}} batches failed; those lines kept the default split",
    "cancel": "Cancel",
    "skippedLines": "{{count}} lines the model could not reproduce kept the default split",
    "inputPlaceholder": "Paste a segmentation to import, or type --ai / --copy-prompt / --copy-seg",
  ...
  "mods": {
    ...
    "signatureUnsignedDetail": "No official signature: this is a third-party mod not reviewed by Folium. Only enable mods from sources you trust.",
    "signatureInvalid": "Signature mismatch",
    "signatureInvalidDetail": "This mod is signed, but the signature does not check out ({{reason}}), so it is no longer officially verified. Usually its files were changed after signing; if you did not change them yourself, do not enable it.",
    "signatureReasons": {
      "malformed": "malformed signature file",
      "unknown-key": "untrusted signing key",
      "revoked-key": "revoked signing key",
      "mod-mismatch": "signed for a different mod id or version",
      "bad-signature": "invalid signature",
      "unverifiable": "files cannot be checked",
      "digest-mismatch": "files changed after signing",
      "revoked-mod": "this mod version was withdrawn by Folium"
    },
    "reload": "Reload",
    ...
    "selectionCount_one": "{{count}} mod selected",
    "selectionCount_other": "{{count}} mods selected",
    "batchEnable": "Enable",
    "batchDisable": "Disable",
    "runCommand": "Run",
    "exporting": "Exporting",
    "running": "Running",
    "clientIssues": "UI code problems",
    "commandUnavailable": "This mod command is no longer available.",
    "cancelExport": "Cancel",
    "commandDone": "Done:",
    "commandFailed": "Command failed",
    "openDirectory": "Open mods folder",
    "directoryOpened": "Opened the mods folder in your file manager",
    "dropZipHint": "Drop a mod .zip here to install it",
    "installing": "Installing mod…",
    "installSuccess": "Installed mod: {{id}} (you can disable or update it from the list)",
    "errors": {
      "no-electron-bridge": "Mod system is unavailable in this environment",
      "open-directory-failed": "Could not open the mods folder: {{value}}",
      "install-no-path": "Could not read the dropped file's location",
      "install-not-zip": "The package must be a .zip file",
      "install-corrupt-zip": "Could not unzip the archive; it may be corrupted",
      "install-empty-zip": "The zip is empty",
      ...
      "export-duration-too-long": "Export range is too long (max 15 minutes)",
      "export-unsupported-platform": "Export is not supported on this platform",
      "export-capture-empty": "Frame capture failed; the render window returned an empty frame",
      "export-cancelled": "Export was cancelled"
    },
    "warnings": {
      "export-alpha-unavailable": "This platform did not preserve the alpha channel; the video has an opaque background. Use a text-only mode with Theme background, or run the export on Windows.",
      "export-alpha-not-guaranteed": "Alpha channel may not be preserved on this platform; verify the exported file or use Windows for a guaranteed transparent background."
    }
  },
  "account": {
    "storage": "Storage",
  ...
  "home": {
    ...
    "latticeAutoFocusOnSongChange": "Auto-focus on track change",
    "latticeLights": "Poster lighting",
    "latticeLightsOn": "Lights on",
    "latticeLightsOff": "Lights off",
    "latticeTools": "Lattice tools",
    "latticeOpenQueueCommand": "Open queue command",
    "latticeHelp": "Operation guide",
    "latticeHelpPoster": "Press Enter to expand the selected song, then Enter again to play",
    "latticeHelpReturn": "Back",
    "latticeHelpMove": "Use the arrow keys to move the selection",
    "latticeHelpCommands": "Open the command palette",
    "latticeHelpOpen": "Exit Lattice",
    "latticePlaybackControls": "Playback controls",
    "latticeOpenPlayer": "OPEN PLAYER",
    "latticeClose": "Close poster",
    "latticeEmptyTitle": "QUEUE IS EMPTY",
    "latticeEmptyText": "Play anything and the queue will spread out here.",
    "latticeBadgeNow": "NOW PLAYING",
    ...
    "loginBackendDown": "The local NetEase service is not running",
  ...
  "options": {
    ...
    "ponderHintsOff": "Off",
    "ponderTouchButton": "Ponder button on touch",
    ...
    "interactionSettingsDesc": "Command palette and keyboard shortcuts.",
    "interactionSettingsPanelDesc": "Command palette and keyboard shortcuts.",
    "gridActionButton": "Grid action button",
    "gridSlideTarget": "Slide left to open",
    "gridSlideTargetDesc": "The slide gesture on the grid's bottom-right button. Tapping still opens the list.",
    "gridSlideTargetFilter": "Filter search",
    "gridSlideTargetFilterDesc": "Opens this grid's filter box.",
    "gridSlideTargetCommandPalette": "Command palette",
    "gridSlideTargetCommandPaletteDesc": "Opens the command list, same as {{modifier}}+K.",
    "gridPaletteHotkey": "Open the command palette with S on a grid",
    "gridPaletteHotkeyDesc": "Off by default: on a grid every printable key is filter input, S included. Turn this on and S opens the command palette instead, while every other key still goes to the filter.",
    ...
    "customShortcutTaken": "That key is already taken by another shortcut",
    "customShortcutLettersOnly": "Letters A\u2013Z only",
    ...
    "transitionAnimationDesc": "Draws the mix while it runs. Not shown for transitions under 5 seconds.",
    "transitionAnimationOff": "Off",
    "transitionAnimationRing": "Screen ring",
    "transitionAnimationRingDesc": "Drawn at the centre of the screen. Any key dismisses it.",
    "transitionAnimationCard": "Card border",
    "transitionAnimationCardDesc": "Drawn on the track card's border, on the pages that card appears on.",
    ...
    "localLibraryAutoScanDesc": "Watch the folders you imported and run an incremental scan whenever their files change.",
    "localLibraryWatchAttaching": "Attaching to the imported folders...",
    "localLibraryWatchNoFolders": "No imported folders yet. Import one from the local library page.",
    "localLibraryWatchNoPermission": "Access expired. Re-import this folder to watch it.",
    "localLibraryWatchActive": "Watching this folder and its subfolders.",
    "localLibraryWatchFailed": "Watch failed",
    "localLibraryWatchStarting": "Starting the watch...",
    "localLibraryWatchRootOnly": "Watching this folder only; subfolders are not covered.",
    "localLibraryWatchScanning": "Scanning changed files...",
    "localLibraryWatchLastScan": "Last auto scan",
    "localLibraryWatchNeverScanned": "No automatic scan has run yet.",
    "localLibraryWatchRecheck": "Re-check folders",
    "r2Sync": "Sync Server",
    ...
    "autoPlayOnLaunch": "Auto-play after opening the app",
    "autoPlayOnLaunchDesc": "Start the restored last session as soon as the app opens, instead of waiting for you to press play.",
    "autoPlayOnLaunchDescSub": "Works on desktop and in an installed PWA. In an ordinary browser tab the autoplay policy may hold playback until you click.",
    ...
    "localLyricFormatOrder": "Local lyric file format priority",
    "localLyricFormatOrderDesc": "When a track has several lyric files with the same name, the first format in this list is used. .fia always comes first. Uploaded lyrics are not affected.",
    "localLyricFormatOrderReset": "Reset",
    "localLyricFormatDragHandle": "Drag to reorder {{format}}",
    "localLyricFormatResyncHint": "The new order applies the next time your local folders are resynced.",
    "localLyricFormatResync": "Resync now",
    "localLyricFormatResyncing": "Resyncing…",
    "localLyricFormatResyncDone": "Local folders resynced",
    "localLyricFormatResyncNoFolders": "No local folders have been imported yet",
    "localLyricFormatResyncFailed": "Failed to resync local folders",
    ...
    "useNativeMacFullscreenButton": "Use native macOS fullscreen button",
    "useNativeMacFullscreenButtonDesc": "Make the window control enter native macOS fullscreen instead of maximizing the window. Off by default.",
    "hidePlayerProgressBar": "Hide player bottom control bar",
    "playerBottomBarOffset": "Bottom controls height",
    "playerBottomBarOffsetDesc": "Adjusts bottom controls, song cards, action buttons and side panels across every page; player subtitles follow too. Capped at half the screen.",
    "playerBottomBarReposition": "Reposition on player page",
    "playerBottomBarRepositionUnavailable": "Play something first — the control bar has to be on screen to move it",
    "playerBottomBarReset": "Reset height",
    "playerBottomBarPositioningHint": "Drag the bar to set its height",
    "playerControlSlots": "Progress bar buttons",
    "playerControlSlotsDesc": "The two buttons to the right of the progress bar. Defaults are loop mode and lyrics timeline.",
    "playerControlSlotPrimary": "Left button",
    "playerControlSlotSecondary": "Right button",
    "playerControlSlotAction_loop": "Loop mode",
    "playerControlSlotAction_prev": "Previous track",
    "playerControlSlotAction_next": "Next track",
    "playerControlSlotAction_shuffle": "Shuffle queue",
    "playerControlSlotAction_like": "Like",
    "playerControlSlotAction_lyricsTimeline": "Lyrics timeline",
    "playerControlSlotAction_volume": "Volume",
    "playerControlSlotAction_queue": "Play queue",
    "playerControlSlotAction_songWall": "Play queue (posters)",
    "playerControlSlotAction_sleepTimer": "Sleep timer",
    ...
    "stageTrackPillDesc": "The bottom-left now playing card on the player and play queue: auto-hide after a while, or keep it always visible / hidden.",
    ...
    "latticeSettings": "Queue collage",
    "latticeVignette": "Edge vignette",
    "latticeVignetteDesc": "Darkens the edges of the queue collage so the middle of the wall carries the eye.",
    "latticePosterTint": "Poster focus tint",
    "latticePosterTintDesc": "Colour inactive posters so the playing, focused, or hovered poster stands out.",
    "latticePosterTintCustomColor": "Force a custom colour",
    ...
    "modVisualizerSettingsDesc": "Settings for the current mode. Applied live and saved automatically.",
    "modVisualizerSettingsReset": "Reset to defaults",
    "modVisualizerSettingsOn": "On",
    "modVisualizerSettingsOff": "Off",
    "foliumTuningDesc": "Added by a mod. Applied live and saved automatically.",
    "foliumMissingSelection": "Your saved choice comes from the mod \"{{modId}}\", which is not running. Showing the default until it is enabled again.",
    ...
    "temperaLyricSection": "Lyric Shots",
    ...
    "temperaWholeLineLyrics": "Show the whole lyric line",
    ...
    "temperaImportImages": "Import backup",
    "temperaExportImages": "Export backup",
    "temperaImportReplaceImages": "Replace current pool",
    "temperaImportAppendImages": "Append to current pool",
    "temperaExportBaseName": "Tempera tuning-canvas images",
    "temperaImportConfirmReplace": "Replacing clears the {{count}} image(s) already in the pool. Continue?",
    "temperaPoolWaitToSave": "Images are still being processed; the pool saves once that finishes",
    "temperaPoolBusyAdd": "Adding…",
    "temperaPoolBusyExport": "Exporting…",
    "temperaPoolBusyImport": "Importing…",
    "temperaLayerImagesAdded": "Added {{count}} image(s)",
    "temperaLayerImagesNotAdded": "{{count}} image(s) not added",
    "temperaPoolImported": "Imported {{count}} image(s)",
    "temperaPoolImportNotAdded": "{{count}} image(s) not imported",
    ...
    "glowBlurQuantizeDesc": "Fixes lyric animations occasionally freezing after long playback on Linux. Chromium leaks shared memory while a lyric glow's blur radius changes every frame; this draws the glow in a way that does not leak and looks nearly the same. On by default on Linux, off elsewhere.",
    ...
    "transcodeFallback": "Convert unsupported audio automatically",
    "transcodeFallbackDesc": "In the Electron app, use FFmpeg to recover local and Navidrome tracks that Chromium cannot decode. The original file is not modified.",
    ...
    "monetShowAudioVisualization": "Audio visualization",
    "monetAudioVisualizationShow": "Show",
    "monetAudioVisualizationHide": "Hide",
    ...
    "soraBackgroundSettings": "Sora Background",
    "soraBlank": "Fully blank",
    "soraBlankDesc": "Skip the WebGL starfield and show a static solid frame: black at night, white in daylight. Pairs well with the video layer.",
    "importFieldSoraBackgroundTuning": "Sora background settings",
    "videoLayerSettings": "Video layer",
    "videoLayerEnabled": "Show video behind lyrics",
    "videoLayerDesc": "A muted video between the background and the lyrics. It plays, pauses and seeks with the music.",
    "videoLayerLocalFile": "Local video",
    "videoLayerLocalFileDesc": "Takes priority over the URL. The pick is remembered after a restart.",
    "videoLayerLocalFileSessionDesc": "Takes priority over the URL. This browser cannot remember the pick, so choose it again after a restart.",
    "videoLayerPickFile": "Choose video",
    "videoLayerRegrant": "Allow access again",
    "videoLayerClearFile": "Clear local video",
    "videoLayerPickFailed": "Could not open the video",
    "videoLayerUrl": "Video URL",
    "videoLayerUrlDesc": "Used when no local video is chosen.",
    "videoLayerOpacity": "Opacity",
    "videoLayerFit": "Fit",
    "videoLayerFitCover": "Cover (crop)",
    "videoLayerFitContain": "Contain",
    "videoLayerNotInExport": "Not included in visual config import/export, and not shown in OBS sources: OBS runs its own browser and cannot open the local video picked here.",
    ...
    "lyricFilterRegex": "Lyric Filtering",
    "lyricFilterRegexDesc": "Line-by-line filter rules, plus how the credit block at the start of the lyrics is handled.",
  ...
  "ponder": {
    ...
    "summaries": {
      ...
      "help_page": "Ponder, the command palette, common examples, and the official documentation.",
      ...
      "lyric_export": "Packs the lyrics cached on this device into one zip of .fia and enhanced LRC files.",
    ...
    "anchors": {
      ...
      "sidePanel": {
        ...
        "sourceGain": "Audio gain",
        "sourceLyrics": "Lyrics",
        "sourceOffset": "Timeline offset",
        "sourceLyricsFile": "Import / export",
        "sourceFileDialog": "Lyric file window",
      ...
      "grid": {
        ...
        "sourceActions": "Source-specific actions",
        "shelf": "3D poster rail",
        "focusedCard": "Focused poster",
        "focusedCopy": "Focused collection details"
      },
      "lattice": {
        "back": "Back",
        "wall": "Queue poster wall",
        "poster": "Queue poster",
        "expanded": "Expanded song",
        "chrome": "Playback controls",
        "tools": "Lattice tools",
      ...
      "gridView": {
        "back": "Back one level",
        "title": "Collection title and info toggle",
        "cards": "Honeycomb song grid",
        "card": "Focused song card",
        "info": "Collection info and batch actions",
        "filter": "Filter this collection"
      }
    },
    "targets": {
    ...
    "scenes": {
      ...
      "gridPageTabs": "Switch sources and source actions",
      "gridPageCards": "Move focus and open a collection",
      "gridPageMap": "See every collection in the map",
      "gridPageSearch": "Search songs, not posters",
      "gridPageKeyboard": "Every Grid3D page shortcut",
      "gridViewPageOverview": "Inside a collection",
      "gridViewPageActions": "Work with a song card",
      "gridViewPageStructure": "The complete collection page",
      "gridViewPageNavigation": "Drag and keyboard navigation",
      ...
      "panelSourceTabExport": "Importing and exporting lyric files",
      "lyricExportScope": "Which songs, which version",
      "lyricExportFormats": "Two formats and file names",
      ...
      "helpPageDocs": "Official documentation",
      ...
      "playerBarVolume": "Volume lives in the palette",
    ...
    "captions": {
      ...
      "onboarding": {
        ...
        "overviewExampleFilter": "Or search within the current playlist again and send the results to the playback queue.",
        "overviewDocs": "For more features and explanations, visit the official documentation site.",
      ...
      "pages": {
        ...
        "gridHelp": "The gear opens Help. When an update is available, its badge appears here too. Help still contains release notes and the Help-page Ponder entry.",
        "gridTabs": "The center tabs switch playlists, radio, albums, local music, Navidrome, and Stage. Lattice appears only when a play queue exists.",
        "gridSearchBox": "The field on the right searches songs in the current source. Enter opens the search workspace; it does not filter the collection posters below.",
        "gridTabResult": "Changing tabs replaces the 3D rail with that source's collections and remembers the last focused position for each source.",
        "gridSourceActions": "These controls appear only when the source needs them: local import and refresh actions, playlist-file import, or a server-library reload.",
        "gridCardMove": "Drag, wheel, or use Left and Right to move the rail. Clicking an off-center poster only centers it; it does not open immediately.",
        "gridCardOpen": "Click the centered poster again, or press Enter, to open its GridView. The copy below always describes the centered poster.",
        ...
        "gridViewTitle": "The centered title shows the collection name and description. When an info panel exists, press the title to expand or collapse it.",
        "gridViewCards": "Songs occupy a draggable honeycomb, not a rigid list. Cards are arranged around the current focus.",
        "gridViewPan": "Drag empty space to move the honeycomb; touch works the same way. Buttons and artist or album links inside cards do not accidentally pan it.",
        ...
        "latticeChrome": "The expanded poster contains play/pause, extra slots, time, scrubbing, and Open Player. Tap the expanded poster again, or press Space, to reveal or hide it.",
      ...
      "sidePanel": {
        ...
        "sourceTab": "This cell is not always there. It is inserted after the artwork tab only when the current song comes from a local file, Navidrome or an online source, and its icon follows that source; play a song with no source of its own and the row is back to four cells.",
        "sourceInfo": "At the top is this song as its source sees it: a local file gives filename, size, bitrate and lyric status, Navidrome gives the server-side song ID, an online source has no such block.",
        "sourceGain": "\u201cAudio gain\u201d is ReplayGain: off, track or album. The value at the right of the heading is what the song itself carries \u2014 T for track, A for album \u2014 and reads as unavailable when the file has none.",
