...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "visualizer-toggle-glow-blur-quantize": { "title": "修复 Linux 歌词动画卡死", "description": "修复 Linux 上长时间播放后歌词动画偶发卡死、画面定格的问题" },
  ...
  "mods": {
    ...
    "signatureUnsignedDetail": "没有官方签名：这是未经 Folium 审查的第三方模组，请只启用你信任来源的模组。",
    "signatureInvalid": "签名不匹配",
    "signatureInvalidDetail": "模组带有签名，但校验失败（{{reason}}），不再视为官方认证。通常是签名后文件被改动过；如果不是你自己改的，请不要启用。",
    "signatureReasons": {
      "malformed": "签名文件格式错误",
      "unknown-key": "签名密钥不受信任",
      "revoked-key": "签名密钥已被吊销",
      "mod-mismatch": "签名对应的模组 id 或版本不符",
      "bad-signature": "签名无效",
      "unverifiable": "文件无法校验",
      "digest-mismatch": "文件在签名后被修改",
      "revoked-mod": "该模组版本已被官方撤回"
    },
    "reload": "重载",
  ...
  "options": {
    ...
    "glowBlurQuantizeDesc": "修复 Linux 上长时间播放后歌词动画偶发卡死、画面定格的问题。原因是歌词发光的模糊半径逐帧变化时，Chromium 会持续泄漏共享内存；开启后改用不会泄漏的方式绘制发光，外观几乎不变。Linux 默认开启，其它平台默认关闭。",
    ...
    "soraBackgroundSettings": "空背景",
    "soraBlank": "完全空白",
    "soraBlankDesc": "不再渲染 WebGL 星空，只显示静态纯色画面：夜间纯黑，日间纯白。适合搭配视频层使用。",
    "importFieldSoraBackgroundTuning": "空背景参数",
    "videoLayerSettings": "视频层",
    "videoLayerEnabled": "在歌词后方显示视频",
    "videoLayerDesc": "在背景和歌词之间铺一层静音视频，跟随音乐播放、暂停和跳转。",
    "videoLayerLocalFile": "本地视频",
    "videoLayerLocalFileDesc": "优先于 URL 使用。重启后自动恢复所选视频。",
    "videoLayerLocalFileSessionDesc": "优先于 URL 使用。当前浏览器无法记住所选文件，重启后需要重新选择。",
    "videoLayerPickFile": "选择视频",
    "videoLayerRegrant": "重新授权访问",
    "videoLayerClearFile": "清除本地视频",
    "videoLayerPickFailed": "无法打开该视频",
    "videoLayerUrl": "视频 URL",
    "videoLayerUrlDesc": "未选择本地视频时使用。",
    "videoLayerOpacity": "不透明度",
    "videoLayerFit": "填充方式",
    "videoLayerFitCover": "铺满（裁切）",
    "videoLayerFitContain": "完整显示",
    "videoLayerNotInExport": "不参与视觉配置导入导出，也不在 OBS 源中显示：OBS 使用独立浏览器，无法读取这里选择的本地视频。",
